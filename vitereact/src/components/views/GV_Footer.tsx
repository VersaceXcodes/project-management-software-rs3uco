    ...
    <footer className="bg-gray-800 text-gray-300 pt-10 pb-6">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          {/* Company Info */}
          <div>
            <h3 className="font-bold text-lg mb-4 text-white">ProjectPro</h3>
            <p className="text-sm mb-4">
              Empowering teams to collaborate effectively and deliver projects on time.
            </p>
            {/* Social Media Icons */}
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/documentation" className="text-sm hover:text-white transition-colors">Documentation</Link>
              </li>
              <li>
                <Link to="/guides" className="text-sm hover:text-white transition-colors">Guides</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <form onSubmit={handleSubscribe} className="flex flex-col space-y-2">
              <input
                ...
                className="px-3 py-2 text-sm bg-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                required
              />
              <button
                type="submit"
